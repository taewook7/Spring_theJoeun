...
<%@ include file = "../include/topmenu.jsp" %>
	...
	<form class="form-horizontal" action = "/board/insert" method = "post"> 
		...
		<div class = "form-group">
			...
			<div class = "col-sm-4">
				<input type="text" class = "form-control" id="b_title" name = "b_title" placeholder="게시글 제목"/>
			</div>
		</div>
		...
		<div class = "form-group">
			...
			<div class = "col-sm-3">
				<input type="text" class = "form-control" id="b_writer" name = "b_writer" placeholder="게시글 작성자"/>
			</div>
		</div>
		
		<div class = "form-group">
			<div class = "col-sm-offset-3 col-sm-2">
				<button type="submit" class="btn_button">등 록</button>
			</div>
		</div>
